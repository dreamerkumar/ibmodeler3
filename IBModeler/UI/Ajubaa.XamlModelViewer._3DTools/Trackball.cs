...
namespace Ajubaa.XamlModelViewer._3DTools
{
    ...
    public class Trackball
    {
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            //vk: added this check on 15-june-2010. double clicking a new file was also triggering the track function
            //so checking for a one minute delay from the initialized time before calling track or zoom
            if ((DateTime.Now - _lastInitializedAt).TotalSeconds > 1)
            {
